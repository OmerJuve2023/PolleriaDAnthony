...
public class testPolleria {
    ...
    public static void main(String[] args) {
        ...
        platos.setCantidad(10);
        platos.setPrecio(20);
        pollerias.add(platos);
        System.out.println(pollerias);
        restaurant.setPlato(pollerias);

        matriz[0]=new precioMezaPolleria();
        matriz[0].setId(1);
